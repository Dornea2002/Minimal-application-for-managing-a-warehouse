...
public class Reflection { //in this class we extract the properties of the data base

    /**
     * In aceasta clasa extragem prorprietatiile fiecarui field al tabelelor din baza de date
     * @param object
     */
